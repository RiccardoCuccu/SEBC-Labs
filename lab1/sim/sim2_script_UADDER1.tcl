...
power add *
run 10 ns
power report -file ./reports/report_power_UADDER1_20.txt

restart -f
power add *
run 100 ns
power report -file ./reports/report_power_UADDER1_200.txt


restart -f
power add *
run 1000 ns
power report -file ./reports/report_power_UADDER1_2000.txt

restart -f
power add *
run 10000 ns
power report -file ./reports/report_power_UADDER1_20000.txt

restart -f
power add *
run 100000 ns
power report -file ./reports/report_power_UADDER1_200000.txt
