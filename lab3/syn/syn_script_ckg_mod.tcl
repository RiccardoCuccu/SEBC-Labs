...
report_timing > ./reports_mod/report_timing_2_changeprobability_comparator.txt
report_power > ./reports_mod/report_power_2_changeprobability_comparator_ckrst.txt
report_power -include_input_nets > ./reports_mod/report_power_2_changeprobability_comparator_input_nets_ckrst.txt
report_power -net -include_input_nets > ./reports_mod/report_power_2_changeprobability_comparator_input_nets_only_nets_ckrst.txt

set_switching_activity -static_probability 0.12 -toggle_rate 0.025 -base_clock clk {INCA INCB}

report_power > ./reports_mod/report_power_2_changeprobability_comparator_inc.txt
report_power -include_input_nets > ./reports_mod/report_power_2_changeprobability_comparator_input_nets_inc.txt
report_power -net -include_input_nets > ./reports_mod/report_power_2_changeprobability_comparator_input_nets_only_nets_inc.txt

report_cell > ./reports_mod/report_cell_2_changeprobability_comparator_inc.txt
...
report_power > ./reports_mod/report_power_3_changeprobability_comparator_ckrstinc.txt
report_power -include_input_nets > ./reports_mod/report_power_3_changeprobability_comparator_input_nets_ckrstinc.txt
report_power -net -include_input_nets > ./reports_mod/report_power_3_changeprobability_comparator_input_nets_only_nets_ckrstinc.txt

report_cell > ./reports_mod/report_cell_3_changeprobability_comparator_ckrstinc.txt
